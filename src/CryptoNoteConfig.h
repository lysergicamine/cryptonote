...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(14446645043909656625);
...
const char     CRYPTONOTE_NAME[]                             = "molecule";
...
const int      P2P_DEFAULT_PORT                              = 48620;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 49150;
